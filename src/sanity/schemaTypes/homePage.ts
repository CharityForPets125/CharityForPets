...
export const homePageType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "number",
      group: "design",
      description: "How dark the hero tint is. 0 = transparent, 100 = solid. Default: 45.",
      validation: (rule) => rule.min(0).max(100),
    }),
    defineField({
      name: "ctaOverlayColor",
      title: "CTA Overlay Color",
      type: "string",
      group: "design",
      description: "Tint color over the CTA section image. Default: dark green.",
    }),
    defineField({
      name: "ctaOverlayOpacity",
      title: "CTA Overlay Opacity (0–100)",
      type: "number",
      group: "design",
      description: "How dark the CTA tint is. 0 = transparent, 100 = solid. Default: 45.",
      validation: (rule) => rule.min(0).max(100),
    }),
