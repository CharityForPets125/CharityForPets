            ...
            <section className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
                <article className="rounded-3xl border border-amber-900/10 bg-white p-6 shadow-sm">
                    ...
                    <ul className="mt-4 space-y-3">
                        ...
                        {!donations?.length && <li className="text-sm text-amber-900/70">{t("dashboard.noDonationsYet")}</li>}
                    </ul>
                </article>
                ...
                <article className="rounded-3xl border border-amber-900/10 bg-white p-6 shadow-sm">
                    ...
                    <ul className="mt-4 space-y-3">
                        ...
                        {!orders?.length && <li className="text-sm text-amber-900/70">{t("dashboard.noOrdersYet")}</li>}
                    </ul>
                </article>
            </section>
