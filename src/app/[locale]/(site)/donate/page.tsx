        ...
        <main className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
            <div className="relative overflow-hidden rounded-2xl border border-emerald-900/10 bg-white shadow-sm sm:rounded-3xl">
                ...
                <div className="relative flex items-center justify-between gap-4 p-5 sm:p-8">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight text-emerald-950 sm:text-3xl lg:text-4xl">{t("donate.title")}</h1>
                        <p className="mt-2 text-sm text-emerald-900/80 sm:mt-3 sm:text-base">{t("donate.description")}</p>
                    </div>
