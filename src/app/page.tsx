      ...
      {homePage?.showAboutSection !== false && (
        <section className="mx-auto mt-10 w-full max-w-6xl px-4 sm:mt-12 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] border border-amber-900/10 bg-white p-6 shadow-sm sm:p-8">
            <h2 className="font-heading text-2xl font-bold text-amber-950 sm:text-3xl">{homePage?.aboutTitle || "Add About Title in Sanity"}</h2>
            <p className="mt-4 text-amber-900/85">{homePage?.aboutText || "Add About Text in Sanity"}</p>
          </div>
        </section>
      )}

      {homePage?.showFeaturedProducts !== false && shopSettings?.isShopSectionVisible !== false && (
        <section className="mx-auto mt-10 w-full max-w-6xl px-4 sm:mt-12 sm:px-6 lg:px-8">
      ...
      {homePage?.showCTASection !== false && (
        <section className="mx-auto mt-10 w-full max-w-6xl px-4 sm:mt-12 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] bg-amber-100 p-6 sm:p-8">
            <h2 className="font-heading text-2xl font-bold text-amber-950 sm:text-3xl">{homePage?.ctaTitle || "Add CTA Title in Sanity"}</h2>
